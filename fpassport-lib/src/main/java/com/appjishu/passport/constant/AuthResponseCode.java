package com.appjishu.passport.constant;
/**
 * @author liushaoming
 * 应答码
 */
public class AuthResponseCode {
    ...
    // userId为null
    public static final String USER_ID_IS_NULL = "2";
    ...
    public static final String USER_CENTER_NOT_EXIST = "704";
    public static final String USER_CENTER_NOT_EXIST_DESC = "用户中心用户不存在";
